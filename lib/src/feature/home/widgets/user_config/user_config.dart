...
import 'package:sos_projeto/src/data/models/integrante_model.dart';
import 'package:sos_projeto/src/data/models/user_model.dart';
import 'package:sos_projeto/src/feature/home/widgets/user_config/cubit/user_cubit_cubit.dart';
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () {
                  context
                      .get<UserCubitCubit>()
                      .save(widget.user.copyWith(name: nomeEC.text))
                      .asyncLoader();
                },
                child: Text('SALVAR'))
          ],
